...
public class panel extends JPanel implements ActionListener {
    ...
    panel() {
        ...
        //this command allow keybord input to be processed
    ...
    public void draw(Graphics graphic) {
        if (flag == true) {
            ...
            graphic.drawString("score:" + score, (width/2 - f.stringWidth("score:"+score)), graphic.getFont().getSize());
        } else {
           gameover(graphic);
        }
    }
    ...
    public void gameover(Graphics graphic){
        ...
        graphic.drawString("GAME OVER!"+ score, (width-f2.stringWidth("GAME OVER!"))/3, height/2);

        //to display the replay prompt
        graphic.setColor(Color.green);
        graphic.setFont(new Font("Comic Sans", Font.BOLD, 40));
        graphic.drawString("Press R to replay" , (width-f.stringWidth("Press R to replay"))/3,height/2 + 150);
    ...
    public void move(){
        //updating all the body parts expact the head
